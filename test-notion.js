...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var dbId, res, props, incomeDbId, resIncome, propsIncome, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dbId = process.env.NOTION_TRANSACTIONS_DB;
                    if (!dbId) {
                ...
                case 2:
                    ...
                    incomeDbId = process.env.NOTION_INCOME_DB;
                    if (!incomeDbId) return [3 /*break*/, 4];
                    return [4 /*yield*/, notion.databases.query({
                ...
                case 3:
                    ...
                    if (resIncome.results.length > 0) {
                        propsIncome = resIncome.results[0].properties;
                ...
                case 5:
                    error_1 = _a.sent();
                    console.error('Error fetching from Notion:', error_1);
                    return [3 /*break*/, 6];
